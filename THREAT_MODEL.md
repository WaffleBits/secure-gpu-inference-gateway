...
- User bypasses request-count or token-budget limits by hammering a high-cost model.
...
- Requests and estimated input-token budgets are limited by principal and model.
...
- Token-budget evidence records estimated counts and configured budgets, not prompt content.
